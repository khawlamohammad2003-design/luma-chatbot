...
function Leads() {
  ...
  const fetchLeads = () => {
    fetch("https://luma-chatbot-green.vercel.app/chat/leads")
      .then((res) => res.json())
      .then((data) => {
        setLeads(data.leads);
  ...
  useEffect(() => {
    const socket = new WebSocket("wss://luma-chatbot-green.vercel.app/ws/leads");
  ...
  const updateStatus = async (id) => {
    await fetch(`https://luma-chatbot-green.vercel.app/chat/leads/${id}/status`, {
      method: "PUT",
    });
  ...
  const saveNotes = async (id) => {
    await fetch(`https://luma-chatbot-green.vercel.app/chat/leads/${id}/notes`, {
      method: "PUT",
      headers: {
  ...
  const saveFollowUp = async (id) => {
    await fetch(`https://luma-chatbot-green.vercel.app/chat/leads/${id}/follow-up`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteLead = async (id) => {
    await fetch(`https://luma-chatbot-green.vercel.app/chat/leads/${id}`, {
      method: "DELETE",
    });
  ...
  const exportExcel = () => {
    window.open("https://luma-chatbot-green.vercel.app/chat/export-leads", "_blank");
  };
